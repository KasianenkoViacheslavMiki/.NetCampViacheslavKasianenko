...
namespace HomeWork3_Task1
{
    public class Storage
    {
        ...
        public Product[] ExceptProductInStorage(Storage secondStorage)
        {
            SortedSet<Product> setFirstStorage = this.UnicalProduct();
            SortedSet<Product> setSecondStorage = secondStorage.UnicalProduct();
            return setFirstStorage.Except(setSecondStorage).ToArray();
        }
        public Product[] IntersectProductInStorages(Storage secondStorage)
        {
            SortedSet<Product> setFirstStorage = this.UnicalProduct();
            SortedSet<Product> setSecondStorage = secondStorage.UnicalProduct();
            return setFirstStorage.Intersect(setSecondStorage).ToArray();
        }
        public Product[] UnionProductInStorages(Storage secondStorage)
        {
            SortedSet<Product> setFirstStorage = this.UnicalProduct();
            SortedSet<Product> setSecondStorage = secondStorage.UnicalProduct();
            return setFirstStorage.Union(setSecondStorage).ToArray();
        }

using HomeWork15_Task1.Model;
using HomeWork15Task1.Migrations;
...
namespace HomeWork15_Task1
{
    public class NetworkCinemaHallsContext: DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=HOME-PC\SQLEXPRESS01;Database=SigmaCinema;TrustServerCertificate=True; Integrated Security=true;");
        }

...
namespace HomeWork15Task1.Migrations
{
    ...
    [Migration("20230122182708_CinemaRowGuidV1.2")]
    partial class CinemaRowGuidV12
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HomeWork15_Task1.Model.Bookings", b =>
                {
                    ...
                    b.Property<Guid?>("PlacesCinemaHallId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HomeWork15_Task1.Model.Bookings", b =>
                {
                    ...
                    b.HasOne("HomeWork15_Task1.Model.PlacesCinemaHall", "PlacesCinemaHall")
                        .WithMany()
                        .HasForeignKey("PlacesCinemaHallId");
